...
// pestañas separadas), porque son las tres cosas que se actualizan a diario
// sobre el estado del proyecto. Gantt queda aparte por ser un cronograma,
// no un estado puntual.
