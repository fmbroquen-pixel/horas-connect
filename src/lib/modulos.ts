...
export const MODULOS: Record<"timeOff" | "cumpleanos" | "expenses", boolean> = {
  ...
  // Expenses (viáticos). Se habia retirado por completo en julio; vuelve
  // detras del flag, con su implementacion en src/app/(app)/viaticos/ y el
  // modelo Viatico de Prisma, que nunca se borro.
  expenses: true,
};
